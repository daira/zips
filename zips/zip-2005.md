...
**$O_1 = O_2 = \mathsf{H^{rivk\_ext}}$.** Both witnesses are
external IVK. If $x_1 = x_2$ (i.e.
$(\mathsf{qk}_1, \mathsf{ak}_1, \mathsf{nk}_1) = (\mathsf{qk}_2, \mathsf{ak}_2, \mathsf{nk}_2)$),
then $\mathsf{sk}_1 = \mathsf{sk}_2 = \bot$ and the witnesses coincide by
functional determinism of $\mathsf{H^{rivk\_ext}}$ and $\mathsf{Commit^{ivk}}$,
contradicting distinctness. Hence WLOG $x_1 \neq x_2$, so the two RO
outputs at $x_1, x_2$ are independent uniform.

**$O_1 = O_2 = \mathsf{H^{rivk\_legacy}}$.** Both witnesses are
external IVK. If $x_1 = x_2$ (i.e. $\mathsf{sk}_1 = \mathsf{sk}_2$), then
$\mathsf{qk}_1 = \mathsf{qk}_2 = \bot$ and the witnesses coincide by functional
determinism of $\mathsf{H^{ask}}, \mathsf{H^{nk}}, \mathsf{H^{rivk\_legacy}},$ and
$\mathsf{Commit^{ivk}}$, contradicting distinctness. Hence WLOG $x_1 \neq x_2$,
so the two RO outputs at $x_1, x_2$ are independent uniform.
