...
$\CommitTrapdoor$, and a generator of random trapdoors, $\CommitGenTrapdoor$.
...
$\ValueLength$, and $\ScalarLength$ be as defined in \crossref{constants}.
...
\vspace{-0.5ex}
Let $\reprJ$ be as defined in \crossref{jubjub}, and $\ExtractJ$ as in \crossref{concretegrouphashjubjub}.
